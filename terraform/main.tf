###############################################################################
# Terraform — System Health Check API
# Deploys the containerised API to AWS ECS Fargate behind an ALB.
# State is stored in an S3 backend (configure before first apply).
###############################################################################
